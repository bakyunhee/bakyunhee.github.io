...
- ### 주요 업무 : 템플릿(Input, DatePicker, Confirm 등) 코드 구현 작업<br>
  ### &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 구현된 템플릿 사용법을 Storybook에 연동하여 구현<br>
- ### 투입 인원 : 2명<br>
- ### 역할 : Front-End<br>

<img src="../assets/img/posts/storybook_list.jpeg" width="450px" title="HomepageWeb"/><br/>
